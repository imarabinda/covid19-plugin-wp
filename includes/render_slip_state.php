...
<div class="ny-covid19-slip js-covid inited <?php echo $all_options['cov_theme'];?>
<?php if((isset($all_options['cov_rtl']) ? $all_options['cov_rtl'] : null)=='on') echo 'rtl_enable'; ?>" style="font-family:<?php echo $all_options['cov_font'];?>">
   ...
   <div class="ny-covid19-slip__tabs__wrap">
      ...
      <?php endif; ?><?php echo esc_html(isset($params['state']) ? $params['state'] : ''); ?></span>  <span onclick="ncrtsTab(event, 'ww')" class="ny-covid19-slip__tabs__item js-covid-tab tablinks"><?php echo esc_html($params['world_title']); ?></span></div>
   </div>
   <div class="ny-covid19-slip__parent">
      ...
      <div class="ny-covid19-slip__content js-covid-content active">
         <div class="ny-covid19-slip__item">
            <div class="ny-covid19-slip__item__diff"><span class="js-covid-ny-con-day">+<?php echo number_format($getFData->deltaconfirmed); ?></span> <span class="ny-covid19-slip__item__info">(<?php echo esc_html($params['today_title']); ?>)</span></div>
            <div class="ny-covid19-slip__item__number js-covid-ny-con-total"><?php echo number_format($getFData->confirmed); ?></div>
         ...
         <div class="ny-covid19-slip__item ny-covid19-slip__item_2">
            <div class="ny-covid19-slip__item__diff ny-covid19-slip__item__fail"><span class="js-covid-ny-dea-day">+<?php echo number_format($getFData->deltadeaths); ?></span> <span class="ny-covid19-slip__item__info">(<?php echo esc_html($params['today_title']); ?>)</span></div>
         ...
         <div class="ny-covid19-slip__item__border">0</div>
         <div class="ny-covid19-slip__item">
            <div class="ny-covid19-slip__item__diff ny-covid19-slip__item__grow"><span class="js-covid-ny-rec-day"><?php echo round(($getFData->recovered)/($getFData->confirmed)*100, 2); ?>%</span></div>
         ...
         <div class="ny-covid19-slip__item__border">0</div>
         <div class="ny-covid19-slip__item ny-covid19-slip__item_2">
            <div class="ny-covid19-slip__item__diff ny-covid19-slip__item__act"><span class="js-covid-ny-act-day"><?php echo round(($getFData->active)/($getFData->confirmed)*100, 2); ?>%</span></div>
